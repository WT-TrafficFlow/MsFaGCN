...
import configparser
from model.MAMGCNtsp_gcn_la import make_model
...
parser.add_argument("--config", default='configurations/METR-LA.conf', type=str,
...
def train_main(_mean, _std):
    ...
    scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=epochs - start_epoch_lr)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        params_filename = os.path.join(params_path, 'METR-LA')
