...
def triple_adjacent(adjacent_file=None, road_segments=30, target_file='adjacent.txt'):
    '''
...
#
# def train_npz(source_file=None, site_num=30, target_file='train.npz'):
#     '''
#     :param source_file:
#     :param site_num:
#     :param target_file:
...
if __name__=='__main__':
    print('hello')
    # 生成三元组形式的邻接矩阵
    triple_adjacent(adjacent_file='adjacent.csv',road_segments=30)
